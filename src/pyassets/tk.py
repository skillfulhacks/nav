...
class TKListbox(tk.Frame):
    def __init__(self, parent, *args, **kwargs):
        tk.Frame.__init__(self, parent)
        self.box = tk.Listbox(self, *args, **kwargs)
        self.vsb = tk.Scrollbar(self, orient="vertical", command=self.box.yview)
        self.hsb = tk.Scrollbar(self, orient="horizontal", command=self.box.xview)
        self.box.configure(yscrollcommand=self.vsb.set)
        self.box.configure(xscrollcommand=self.hsb.set)
        self.vsb.pack(side="right", fill="y")
        self.hsb.pack(side="bottom", fill="x")
        self.box.pack(side="left", fill="x", expand=True)
        
        self.insert = self.box.insert
        self.bind = self.box.bind
        self.curselection = self.box.curselection
        self.get = self.box.get
        self.delete = self.box.delete
